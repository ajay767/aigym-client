    ...
    return (
      <div className="relative">
        ...
        <Section className="mt-10">
          <div className="h-40 w-full bg-blue-500 rounded">
            <div className="flex absolute left-6 items-center ">
            <div className="p-4 text-white border-4 w-16 rounded-full mt-5 ">85%</div>
            <p className="text-white ml-2">Wallet Balance</p>
            </div>
